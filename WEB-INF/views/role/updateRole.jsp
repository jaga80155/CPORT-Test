...
<script type="text/javascript">
	$(document)
			.ready(
					function() {
						...
						$('#wwctrl_layerslist').children('label').each(
								function() {
									$(this).after("<br>");
								});

						var roleId = "<s:property value="
						fieldErrors.get('roleId').get(0)
						"/>";
						var roledesc = "<s:property value="
						fieldErrors.get('roledesc').get(0)
						"/>";
						var layerslist = "<s:property value="
						fieldErrors.get('layerslist').get(0)
						"/>";

						var roleName = "<s:property value="
						fieldErrors.get('roleName').get(0)
						"/>";
						...
						$('#idroleId')
								.change(
										function(event) {
											...
											var roleId = $("#idroleId").val();
											var name = $(
													"#idroleId option:selected")
													.text();

											checkboxes = document
													.getElementsByName('layerslist');
											...
											$
													.getJSON(
															...
															function(
																...
																$('#roledesc')
																		.val(
																				jsonResponse.roleDescription);
																var str = jsonResponse.layerList;
																for (var iCount = 0; iCount < checkboxes.length; iCount++) {
																	for (var jCount = 0; jCount < str.length; jCount++) {
																		if (checkboxes[iCount].value == str[jCount]) {
																			checkboxes[iCount].checked = true;
																		}
																	}
																}
	...
	function resetAddRolePage() {
		window.location.href = "resetUpdateRolePage";
	}
</script>
		...
		<div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<div class="forums">
						<h1>
							Update Role<img src="images/small_arrow.png">
						</h1>
					</div>
				</div>
			...
			<s:form class="form-horizontal" action="updateRole" method="post">
				<div class="row">
					...
					<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
						...
						<div class="forums">
							...
							<s:if test="%{#status=='failure'}">
								<div style="text-align: center; color: red; font-size: 14px;">
									<img src="images/error.jpg" width="20px" /> &nbsp;
									<s:text name="Failed to update role." />
								</div>
								<br />
							</s:if>
							<s:if test="%{#status=='success'}">
								<div style="text-align: center; color: green; font-size: 14px;">
									...
									<s:text name="Successfully updated the role." />
								</div>
								<br />
							</s:if>
							...
							<div class="row">
								...
								<div class="col-md-5 col-sm-5">
									...
									<button type="button" class="btn buts"
										onclick="resetAddRolePage()">Reset</button>
								</div>
							...
							<table class="table table-bordered" id="myTable">
								...
								<tbody>
									<s:iterator value="roleList">
										<tr>
											<td
												style="border: 1px solid #c19878; font-family: 'verdana'; font-size: 12px;"><s:property
													value="roleId" /></td>
											<td
												style="border: 1px solid #c19878; font-family: 'verdana'; font-size: 12px;"><s:property
													value="roleName" /></td>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-hidden"
						id="checklistdiv2">
						...
						<div class="checkbox_role" id="checklistdiv"
							style="overflow: auto; border: 1px solid #c19878; width: 300px; height: 272px; scrollbar-track-color: #c19878;">


							<s:checkboxlist list="layerList" name="layerslist"
								cssClass="lbl_checkbox" id="layerslist"
								cssStyle="font-family:'verdana';font-size:12px;" />
							<!-- list="layerList" -->
						</div>
						<br />
						<div align="center">
							<input type="button" name="Check_All" value="Check All"
								...
								onclick="UncheckAll()" class="btn buts"> <span
								class="tooltiptext2" id="checklistspan"
								style="bottom: 93%; left: 60%;"></span>
						</div>
						<br />
						<br />
					</div>
