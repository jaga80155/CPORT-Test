...
<body class="bgs_1" onload="noback();">
	...
	<h2 style="text-align: center; color:white;" class="text-info">
	...
	<div>
		<h3 style="color: white; text-align: center" align="center">Form submission failed, duplicate request detected</h3>
		<h4 style="color: white; text-align: center" align="center"> The form has already been processed or no token was supplied.
